        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <a
              ...
              className="group flex h-14 w-14 items-center justify-center rounded-full bg-[#2b69ee] text-white shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-[#12d1c0]/40 focus:outline-none focus:ring-2 focus:ring-[#12d1c0] focus:ring-offset-2"
              aria-label="Call Us"
            >
